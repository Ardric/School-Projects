...
Thread::Thread(const char* threadName, bool isjoinable = false)
{
    joinready = new Semaphore("joinready", 0);
    finishready = new Semaphore("finishready", 0);
    joinable = isjoinable;
    name = const_cast<char *>(threadName);
    stackTop = NULL;
    stack = NULL;
    status = JUST_CREATED;
#ifdef USER_PROGRAM
...
Thread::Fork(VoidFunctionPtr func, int arg)
{
    ...
    //-------------------
    parent = currentThread;		// Parent being assigned for thread being forked
